...
RSpec.describe I18nContextGenerator::Parsers::StringsParser do
  ...
  describe '#parse' do
    it 'returns an array of TranslationEntry objects' do
      ...
      expect(entries.first).to be_a(I18nContextGenerator::Parsers::TranslationEntry)
    end
  ...
  describe 'edge cases' do
    ...
    it 'handles strings with escaped quotes' do
      ...
      FileUtils.rm_f(file_with_escapes)
    end
    ...
    it 'handles strings with newlines' do
      ...
      FileUtils.rm_f(file_with_newlines)
    end
    ...
    it 'handles unicode characters' do
      ...
      FileUtils.rm_f(file_with_unicode)
    end
  end
end
